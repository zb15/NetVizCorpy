from NetVizCorpy import Searcher, NetworkBuilder, Cleaner, Visualiser
...
company_a = Searcher('Volvo Cars', 'exact').choose_company()
...
Visualiser(cleanedNetwork, "VolvoCars_Level3_Demo").visualise_b2b_network()
